...
El backend está corriendo en: `http://localhost:3002`
...
### 1. Crear Registro
```
POST http://localhost:3002/api/registrations
```
...
- ✅ Teléfono válido (+34 XXX XXX XXX)
...
Conecta tu frontend usando la URL: `http://localhost:3002/api`
